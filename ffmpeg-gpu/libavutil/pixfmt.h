...
enum AVPixelFormat {
    ...
    /**
     * IEEE-754 single precision planar RGB 4:4:4, 96bpp, little-endian
     * 
     * This format is to support tensorrt inference on NVIDIA GPU.
     * Can only be used as sw_format of CUDA HW frames.
    */
     ...
     * This format is to support tensorrt inference on NVIDIA GPU.
     * Can only be used as sw_format of CUDA HW frames.
     * Note that all three components are put in frame->data[0] in CHW order
    */
