...
template<class YuvUnitx2, class Rgb, class RgbUnitx2>
__global__ static void YuvToRgbPlanarShiftNormKernel(uint8_t *pY, int nv12Linesize,
    ...
    uint8_t *pUV = pY + nv12Linesize * nHeight;
    uint8_t *pSrcY = pY + x * sizeof(YuvUnitx2) / 2 + y * nv12Linesize;
    uint8_t *pSrcUV = pUV + x * sizeof(YuvUnitx2) / 2 + y / 2 * nv12Linesize;
...
void Nv12ToColor32(uint8_t *dpNv12, int nNv12Pitch, uint8_t *dpBgra, int nBgraPitch, int nWidth, int nHeight, cudaStream_t stream, int iMatrix) {
...
template void Nv12ToColor32<BGRA32>(uint8_t *dpNv12, int nNv12Pitch, uint8_t *dpBgra, int nBgraPitch, int nWidth, int nHeight, cudaStream_t stream, int iMatrix);
template void Nv12ToColor32<RGBA32>(uint8_t *dpNv12, int nNv12Pitch, uint8_t *dpBgra, int nBgraPitch, int nWidth, int nHeight, cudaStream_t stream, int iMatrix);
...
void Nv12ToRgbpf32(uint8_t *dp_nv12, int nv12_pitch, uint8_t *dp_rgbpf32, int rgbpf32_pitch, int width, int height, CUstream stream, int matrix)
{
    SetMatYuv2Rgb(matrix, stream);
    YuvToRgbPlanarShiftNormKernel<uchar2, RGBAF32, float2>
    <<<dim3((width + 63) / 32 / 2, (height + 3) / 2 / 2), dim3(32, 2), 0, stream>>>
    (dp_nv12, nv12_pitch, dp_rgbpf32, rgbpf32_pitch, width, height);
}
void Nv12ToRgbpf32Shift(uint8_t *dp_nv12, int nv12_pitch, uint8_t *dp_rgbpf32, int rgbpf32_pitch,
    int width, int height, float norm, float* shift, CUstream stream, int matrix)
{
    SetMatYuv2Rgb(matrix, stream);
    YuvToRgbPlanarShiftNormKernel<uchar2, RGBAF32, float2>
    <<<dim3((width + 63) / 32 / 2, (height + 3) / 2 / 2), dim3(32, 2), 0, stream>>>
    (dp_nv12, nv12_pitch, dp_rgbpf32, rgbpf32_pitch, width, height, norm, shift[0], shift[1], shift[2]);
}
void Nv12ToBgrpf32Shift(uint8_t *dp_nv12, int nv12_pitch, uint8_t *dp_rgbpf32, int rgbpf32_pitch,
    int width, int height, float norm, float* shift, CUstream stream, int matrix)
{
    SetMatYuv2Rgb(matrix, stream);
    YuvToRgbPlanarShiftNormKernel<uchar2, BGRAF32, float2>
    <<<dim3((width + 63) / 32 / 2, (height + 3) / 2 / 2), dim3(32, 2), 0, stream>>>
    (dp_nv12, nv12_pitch, dp_rgbpf32, rgbpf32_pitch, width, height, norm, shift[0], shift[1], shift[2]);
}
void Rgbpf32ToNv12(uint8_t *dp_rgbpf32, int rgbpf32_pitch, uint8_t *dp_nv12, int nv12_pitch, 
    int width, int height, CUstream stream, int matrix)
{
    SetMatRgb2Yuv(matrix, stream);
    RgbpToYuvKernel<uchar2, RGBAF32, float2>
        <<<dim3((width + 63) / 32 / 2, (height + 3) / 2 / 2), dim3(32, 2), 0 , stream>>>
        (dp_rgbpf32, rgbpf32_pitch, dp_nv12, nv12_pitch, width, height);
}

template<class COLOR32>
void Color32ToNv12(uint8_t *dpBgra, int nBgraPitch, uint8_t *dpNv12, int nNv12Pitch, int nWidth, int nHeight, cudaStream_t stream, int iMatrix){
    SetMatRgb2Yuv(iMatrix);
...
template void Color32ToNv12<RGBA32>(uint8_t *dpBgra, int nBgraPitch, uint8_t *dpNv12, int nNv12Pitch, int nWidth, int nHeight, cudaStream_t stream, int iMatrix);
