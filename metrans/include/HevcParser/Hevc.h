...
public:
	ShortTermRefPicSet() {}
	ShortTermRefPicSet(const ShortTermRefPicSet& set) {
		inter_ref_pic_set_prediction_flag = set.inter_ref_pic_set_prediction_flag;
		delta_idx_minus1 = set.delta_idx_minus1;
		delta_rps_sign = set.delta_rps_sign;
		abs_delta_rps_minus1 = set.abs_delta_rps_minus1;
		used_by_curr_pic_flag = set.used_by_curr_pic_flag;
		use_delta_flag = set.use_delta_flag;
		num_negative_pics = set.num_negative_pics;
		num_positive_pics = set.num_positive_pics;
		delta_poc_s0_minus1 = set.delta_poc_s0_minus1;
		used_by_curr_pic_s0_flag = set.used_by_curr_pic_s0_flag;
		delta_poc_s1_minus1 = set.delta_poc_s1_minus1;
		used_by_curr_pic_s1_flag = set.used_by_curr_pic_s1_flag;
	}
...
public:
	...
	std::shared_ptr<SeiPayload> sei_payload;
...
public:
	...
	std::vector<std::vector<int32_t> > ver_filter_coeff;

	uint32_t num_horizontal_filters;
	std::vector<uint32_t> hor_tap_length_minus_1;
	std::vector<std::vector<int32_t> > hor_filter_coeff;
...
public:
	enum SliceType {
		B_SLICE = 0, P_SLICE = 1, I_SLICE = 2, NONE_SLICE = 3
	};
